...
export default class MembershipTiersMobile extends Component {
  render() {
    return (
      <Grid.Row stretched columns={1} style={{margin: '10px 10px 10px 10px', maxWidth: '400px'}}>
        <Grid.Column centered style={{margin: '10px 0 10px 0'}}>
